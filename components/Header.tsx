...
export default function Header() {
  ...
  return (
    <header className="flex w-full md:w-[360px] justify-between items-center px-[6%] overflow-hidden py-[5px] bg-white shadow-md relative z-50">
      <div className="font-bold text-xl flex items-center gap-2">
        <Image width={60} height={60} src={'/logo1.svg'} alt='logo'/>
      </div>
      ...
      >
        <div className="flex flex-col p-6 space-y-4 font-medium">
          ...
          <Link href="https://docs.google.com/forms/d/1M_71hWWL_pbyA5OoA5CS7-QUHN54raCPTC9o4jytlu4/edit" onClick={() => setOpen(false)} className="text-red-900 font-semibold hover:font-bold hover:text-red-700">Order</Link>
        </div>
      </aside>
    </header>
  );
