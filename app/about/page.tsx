...
export default function About() {
  ...
  return (
    <section className="max-w-[500px] mx-auto text-center">
      <Image src={'/about1.svg'} width={500} height={300} alt=""/>
      <div className=" mt-8 flex flex-col gap-12">
        <div>
            <h2 className="text-3xl font-bold mb-4">Our Story</h2>
            <p className="px-16 mb-6">
        ...
        <div className="absolute translate-y-50">
          <Image src={"/about2.svg"} width={240} height={150} alt="about2"/>  
        </div>

        <div className="mt-22 pl-50 text-right">
        ...
        <div className="text-left my-16 max-w-[500px] flex justify-between">
            <div className="pl-12 relative z-10">
                <h3 className="text-3xl font-bold mb-4">Our Vision</h3>
                <p className="w-42 mb-6">
            ...
            <Image className="absolute translate-x-0 -translate-y-40" src={"/about3.svg"} width={500} height={150} alt="about3"/>  

        </div>
      </div>

      <div style={style} className="mt-6 py-12 px-6 max-w-[500px]">
