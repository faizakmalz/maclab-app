...
export default function Menu() {
  ...
  return (
    <section className="flex flex-col gap-4 w-full md:w-[360px] mx-auto text-center overflow-x-hidden">
            ...
            <div className="grid grid-cols-3 gap-6 mb-10">
                ...
                <div key={i} className="flex flex-col items-center rounded-xl shadow-lg overflow-hidden bg-white">
                    <img
                        ...
                        className="w-[120px] absolute h-[120px] object-cover -translate-y-8"
                    />
                    <div className="bg-[#F6B70D] w-full h-26 flex justify-center">
                    </div>
                    <div className="w-full h-30 bg-white flex flex-col justify-between text-center py-2 px-2 rounded-t-2xl -mt-6">
    ...
    <div className="bg-[#FFD972] flex flex-col gap-1 px-7 py-6 w-full shadow-md">
        <h2 className="font-bold text-3xl text-left -translate-x-2">Add On</h2>
